...
SERVER_DOMAIN="${SERVER_DOMAIN:-staging.linux.achievengine.com}"
...
DEPLOY_STACK_NAME="${DEPLOY_STACK_NAME:-clearhealth-mvp-staging}"
...
echo "=========================================="
echo "Zero-Downtime Deployment (Staging)"
echo "=========================================="
...
echo "✅ Staging deployment complete. Active port is now ${NEW_PORT}."
